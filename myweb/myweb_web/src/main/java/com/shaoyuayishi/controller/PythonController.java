package com.shaoyuayishi.controller;

import com.shaohuayishi.pojo.Result;
...
public class PythonController {
    ...
    public Result getPage() {
        ...
        //C:\Users\rentaotao\Desktop\myWeb\myweb\myweb_web\target\myweb_web-1.0-SNAPSHOT\study\python\mzitu.txt
        if (filePath == null) {
    ...
    private String getFilePath(String fileName) {
        ...
        for (int i = 0; i < list.size(); i++) {
            String[] strs = list.get(i).split(fileSeparator);
